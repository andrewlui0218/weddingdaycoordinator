...
const initialPhotos: PhotoItem[] = [
  ...
  { id: 5, guest: "新郎馮氏親友+鄧偉輝、郭麗璇 陳嵐 (table 9)" },
  { id: 6, guest: "新郎父母親友：蔡漢樑、戴謙寶 (table 9)" },
  { id: 7, guest: "新郎父母親友 (table 10)" },
  { id: 8, guest: "雙方家人" },
  { id: 9, guest: "新娘家人" },
  { id: 10, guest: "新娘親戚 (table 2)" },
  { id: 11, guest: "兄弟姐妹團" },
  { id: 12, guest: "新郎中學同學 (table 13)" },
  { id: 13, guest: "新郎大學同學 (table 15)" },
  { id: 14, guest: "新郎那打素PHYSIO同事 (Table 16)" },
  { id: 15, guest: "新郎那打素PHYSIO同事 (Table 19)" },
  { id: 16, guest: "新郎那打素PHYSIO同事 (Table 20)" },
  { id: 17, guest: "新郎那打素PHYSIO同事 (Table 21)" },
  { id: 18, guest: "全部 新郎那打素PHYSIO同事" },
  { id: 19, guest: "新娘中學同學 (table 8)" },
  { id: 20, guest: "新娘大學同學 (table 5)" },
  { id: 21, guest: "新娘那打素 骨科同事 (Table 11)" },
  { id: 22, guest: "新娘那打素骨科同事 (Table 12)" },
  { id: 23, guest: "新娘那打素骨科同事 (Table 18)" },
  { id: 24, guest: "新娘那打素骨科同事 (Flora, Rainbow and husband) (table 5)" },
  { id: 25, guest: "全部 新娘那打素骨科同事" },
  { id: 26, guest: "自由合照" },
];
